...
@Component({
    ...
    imports: [RouterOutlet, HomeComponent, SigninComponent,  FormsModule , FormsComponent,CommonModule,MsgComponent]
})
export class AppComponent {
  ...
  navigateWithEncryptedParams() {
    const param = 'app-msg';
    const encryptedParam = this.services.encrypt(param);
